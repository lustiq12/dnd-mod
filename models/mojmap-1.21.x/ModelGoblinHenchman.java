...
public class ModelGoblinHenchman<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "goblinhenchman"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone10 = bone4.addOrReplaceChild("bone10",
				CubeListBuilder.create().texOffs(20, 22)
						.addBox(0.0F, -2.0F, -3.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(20, 12)
						.addBox(0.5F, -3.0F, -10.0F, 0.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
