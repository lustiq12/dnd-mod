...
public class SpearProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(DndModItems.SPEAR.get());
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(DndModItems.SPEAR.get());
	}
	...
	public static SpearProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SpearProjectileEntity entityarrow = new SpearProjectileEntity(DndModEntities.SPEAR_PROJECTILE.get(), entity, world, null);
	...
	public static SpearProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		SpearProjectileEntity entityarrow = new SpearProjectileEntity(DndModEntities.SPEAR_PROJECTILE.get(), entity, entity.level(), null);
