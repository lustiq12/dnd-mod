...
public class TemplateMobRenderer extends MobRenderer<TemplateMobEntity, LivingEntityRenderState, ModelGoblinWarrior> {
	private TemplateMobEntity entity = null;
	...
	@Override
	public void extractRenderState(TemplateMobEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends ModelGoblinWarrior {
		...
		public void setEntity(TemplateMobEntity entity) {
			this.entity = entity;
		}
